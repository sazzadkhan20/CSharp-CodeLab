...
namespace ConsoleAppClassD
{
    ...
    class Student
    {
        ...
        {
            if (this.Cgpa >= 3.5 && this.Cgpa <= 4.0)//if (this.GetCgpa() >= 3.5 && this.GetCgpa() <= 4.0)
                return "Grade Letter: A+"; //Console.WriteLine("Grade Letter: A+");
            else if (this.Cgpa >= 3.0 && this.Cgpa < 3.5)//else if (this.GetCgpa() >= 3.0 && this.GetCgpa() < 3.5)
                return "Grade Letter: A"; //Console.WriteLine("Garde Letter: A");
            else if (this.Cgpa == -1)//else if (this.GetCgpa() == -1)
                return "Grade Letter: Invalid"; //Console.WriteLine("Garde Letter: Invalid");
            else
                return "Grade Letter: F";//Console.WriteLine("Garde Letter F");
        }
        ...
        public void PrintStudentInfo()
        {
            ...
            this.Address.PrintAddress();//this.address.PrintAddress();
        }
    }
}
